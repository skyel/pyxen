...
class rp_fannkuch_bm:
    ...
    def fannkuch(n):
        ...
        while 1:
            ...
            if perm1[0] != 0 and perm1[m] != m:
                ...
                k = perm[0]
                while k:
                    perm[:k+1] = rp_fannkuch_bm.reverse_list(perm[:k+1])
    ...
    def rp_fannkuch_main(n):
        ...
        for i in xrange(iterations):
            t0=time.time()
            rp_fannkuch_bm.fannkuch(rp_fannkuch_bm.DEFAULT_ARG)
            t1=time.time()
    ...
    @staticmethod
    def boot(n):
        rp_fannkuch_bm.rp_fannkuch_main(n)
